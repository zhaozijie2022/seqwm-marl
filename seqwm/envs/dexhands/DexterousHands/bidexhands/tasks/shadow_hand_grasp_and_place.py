...
class ShadowHandGraspAndPlace(BaseTask):
    ...
    def __init__(
        ...
        if self.obs_type in ["point_cloud"]:
            from PIL import Image as Im
            from seqwm.envs.dexhands.DexterousHands.bidexhands.utils import (
                o3dviewer,
            )
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        table_texture_files = os.path.join(
            os.getcwd(),
            "../seqwm/envs/dexhands/DexterousHands/assets/textures/texture_stone_stone_texture_0.jpg",
        )
        ...
        if self.obs_type in ["point_cloud"]:
            ...
            if self.point_cloud_debug:
                ...
                from seqwm.envs.dexhands.DexterousHands.bidexhands.utils.o3dviewer import (
